...
{
    [ConnectionKey("adham"), Module("AdhomStoreCom"), TableName("[dbo].[Product]")]
    ...
    public sealed class ProductRow : Row<ProductRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Cat"), Column("Cat_Id"), ForeignKey("[dbo].[Category]", "Id"), LeftJoin("jCat"), TextualField("CatName")]
        ...
        [DisplayName("Supllier Name"), Size(50)]
