...
import { ProductImageForm, ProductImageRow, ProductImageService } from '../../ServerTypes/AdhomStoreCom';

@Decorators.registerClass('AdminPanel.AdhomStoreCom.ProductImageDialog')
