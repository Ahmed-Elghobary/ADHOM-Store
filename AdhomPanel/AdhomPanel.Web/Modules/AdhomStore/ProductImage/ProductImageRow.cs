...
{
    [ConnectionKey("Adham"), Module("AdhomStore"), TableName("[dbo].[ProductImage]")]
    ...
    public sealed class ProductImageRow : Row<ProductImageRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Image"), QuickSearch, NameProperty, ImageUploadEditor]//MultipleImageUploadEditor]
        public string Image
        {
